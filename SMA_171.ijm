...
var Fascicle_length_trig = newArray();
...
macro "SMA - Simple Muscle Architecture Analysis" {
	...
	function singleImageAnalysis() {
		...
		Fascicle_length_trig = Array.concat(Fascicle_length_trig, Lf_trig);
		...
		Fascicle_length_trig = arrTidy(Fascicle_length_trig);
